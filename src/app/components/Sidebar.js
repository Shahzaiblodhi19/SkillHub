        ...
        <div className="h-screen = flex flex-col justify-between " >
            <div className="border-r h-full flex flex-col">
                ...
                <div className="sidebar">
                    <div style={{height: isSidebarOpen === true ? '475px' : '360px'}}>
                        {/* Menu Items */}
                    ...
                    <nav className="flex-grow" style={{ position: 'fixed',width: isSidebarOpen === true ? '246px' : '80px'}}>
                        <ul className="space-y-2 mx-3 mt-3 border-b pb-2">
                            <li style={{ display: 'none' }} className={`nav-item mb-3`} onClick={() => isMobileView ? setisSidebarActive(true) : setIsSidebarOpen(true)}>
                                <a
                                    href="#"
                                    className="flex items-center p-2 "
                                >
