                    ...
                    <div className="popup">
                        ...
                        {activeTab === "Details" && (
                            <div className="popup-content pb-0 pt-3 -lg">
                                ...
                                <p style={{ fontSize: '12px', color: 'grey' }}>Enter the basic community details such as the title and description. We'll use your title to generate the URL.</p>
                                <form onSubmit={handleSubmit} id="courseForm">
                                    ...
                                    <p style={{ fontSize: '12px', color: 'grey' }}>Manage space details and view Access Options.</p>
                                    <div className="mt-3">
