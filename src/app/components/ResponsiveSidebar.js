...
const ResponsiveSidebar = ({ schoolName, selectedEmoji, isSidebarActive, setisSidebarActive,
    ...
    return (
        <>
            {isSidebarActive &&
                <div className={`responsivesidebar-panel ${isSidebarActive ? 'active' : ''}`} style={{ zIndex: '1000' }}>
            ...
            {isSidebarSmallActive &&
                <div className={`responsivesidebar-panel ${isSidebarSmallActive ? 'active' : ''}`} style={{ zIndex: '1000', width: '230px' }}>
                    <div className="h-screen = flex flex-col justify-between " >
                        <div className="border-r h-full flex flex-col">
                            {/* Logo */}
