                    ...
                    {AllCourses.map((course, index) => (
                        <>
                            ...
                            <div className="flex flex-col" >
                                <div className="w-100 py-2 px-3 fw-bold flex items-center justify-between" style={{ background: '#F0F3FA', borderTopLeftRadius: '10px', borderTopRightRadius: '10px' }}>
                                    ...
                                    <span><svg className="w-5 h-5" style={{ rotate: '90deg' }} viewBox="0 0 24 24">
                                        <path fill="#5D625E" d="M12 8c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm0 2c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm0 6c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z" />
                                    </svg></span>
                                </div>
                                <div
                                    key={index}
