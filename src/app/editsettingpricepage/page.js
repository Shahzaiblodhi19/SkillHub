                    ...
                    <div className="popup-header w-100">
                        ...
                        <div className="flex flex-wrap items-center w-100 ">
                            <div className="flex flex-wrap items-center gap-4 w-100">
                                ...
                                />
                                <div className="flex flex-wrap flex-col gap-3 w-100 ">
                                    ...
                                    <div className="d-flex flex-wrap flex-column flex-md-row align-items-start aling-items-md-center justify-content-between gap-3">
                                        <div className="d-flex flex-wrap flex-wrap gap-4" style={{ fontSize: '13px', fontWeight: '600' }}>
                                            <button
                                        ...
                                        <button style={{ fontSize: '13px', fontWeight: '600' }} className="px-3 py-1 bg-grey-100 border-1 text-gray-600 rounded-md flex flex-wrap items-center gap-2 hover:bg-gray-200">
                                            <span>👁</span> Preview
                                        </button>
                                    </div>
                                </div>
                                                    ...
                                                    <div className="mt-6">
                                                        <div className="flex flex-wrap items-center justify-between px-3 py-2 border rounded-lg shadow-sm bg-gray-50">
                                                            <div className="flex flex-wrap items-center">
                                                                ...
                                                                />
                                                                <div className="inline-flex flex-wrap flex-col gap-2">
                                                        ...
                                                        <div className="flex flex-wrap flex-wrap gap-2 mt-5 mb-4 text-sm">
                                                            {/* All */}
                                                            <button
                                        ...
                                        <div className="flex flex-wrap items-center gap-3">
                                            <div className="w-1/4 relative">
                                                ...
                                                <button
                                                    ...
                                                    className="absolute inset-0 flex flex-wrap items-center justify-center bg-black bg-opacity-10 rounded-md"
                                                >
                                                    <svg
                                                        xmlns="http://www.w3.org/2000/svg"
                                                        fill="#13C4CC"
                                                ...
                                                <div className="relative" style={{ marginTop: '48px' }}>
                                                    <div className="flex flex-wrap items-center justify-between">
                                                        <button
                                                            ...
                                                            className="flex flex-wrap items-center gap-1.5 fw-medium text-sm border-2 rounded-full  px-3 py-1"
                                                        >
                                            ...
                                            <div className="form-group">
                                                ...
                                                {questions.map((question) => (
                                                    <div key={question.id} className="mb-3 px-3 py-3 rounded" style={{ background: '#f8f8f8' }}>
                                                        {/* Question Label */}
                                                        <div
                                                            className="flex flex-wrap justify-between items-center cursor-pointer gap-3"
                                                            ...
                                                            <div className="p-0 mt-3">
                                                                ...
                                                                <div className="flex flex-wrap items-center justify-between">
                                                                    <button
                                                                        ...
                                                                        className="flex flex-wrap items-center text-red-500 hover:text-red-700 text-sm"
                                                                    >
                                                                ...
                                                                <div className="form-group px-3 py-3 border rounded-lg">
                                                                    ...
                                                                    <div className="flex flex-wrap items-center gap-4" style={{ width: "100%" }}>
                                                                        ...
                                                                        <div className="flex flex-wrap flex-col">
                                                                            ...
                                                                            <label
                                                                                htmlFor="avatarInput"
                                                                                className="upload-button inline-flex flex-wrap items-center gap-2 mt-2 w-fit"
                                                                        ...
                                                                        <div className="upload-preview relative flex-col flex-md-row">
                                                                            ...
                                                                            <div className="upload-info">
                                                                                ...
                                                                                <label
                                                                                    ...
                                                                                    className="upload-button inline-flex flex-wrap items-center gap-2 mt-1 w-auto"
                                            ...
                                            {selectedProducts.map((product) => (
                                                <div key={product.id} className="selected-product flex flex-wrap items-center justify-between mb-4 cursor-pointer">
                                                    <div className="flex flex-wrap items-center gap-3">
                                                        ...
                                                        <div className="info flex flex-wrap flex-col">
                                                            <div className="flex flex-wrap items-center gap-3">
