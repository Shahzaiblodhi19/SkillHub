            ...
            <div className="row p-4">
                ...
                <div className="bg-white col-xl-7 col-md-12 border-gray-100 rounded-lg border-2 p-4">
                    <div className="flex items-center justify-between flex-wrap">
                        ...
                        <div className="flex items-center flex-wrap gap-x-3 md:gap-x-0">
                            ...
                            <h2 className="text-lg font-semibold secpars" style={{display: 'none'}}>Password</h2>
                            <div className="ml-4 my-3 my-md-0 mll">
                                <h2 className="text-lg font-semibold secpar">Password</h2>
                ...
                <div className="bg-white col-xl-7 col-md-12 border-gray-100 rounded-lg border-2 p-4">
                    <div className={`${editgooglesettings === true ? 'bg-gray-100 p-3 rounded-lg' : ''}`}>
                        <div className="flex items-center justify-between flex-wrap">
                            ...
                            <div className="flex items-center flex-wrap gap-x-3 md:gap-x-0">
                                ...
                                <h2 className="text-lg font-semibold secpars" style={{display: 'none'}}>Google</h2>
                                <div className="ml-4 my-3 my-md-0 mll">
                                    <h2 className="text-lg font-semibold secpar">Google</h2>
                        ...
                        {editgooglesettings &&
                            <div className="flex justify-between flex-col gap-4 md:gap-0 md:flex-row items-start md:items-center bg-white shadow-sm mt-4 rounded-lg p-4">
                                ...
                                {/* Status and Actions */}
                                <div className="flex items-start md:items-center justify-end flex-col md:flex-row ">
                                    {/* Status */}
                                    ...
                                    {/* Buttons */}
                                    <div className="flex space-x-3 mt-4 md:mt-1 mt-md-1">
                                        {/* Reconnect Button */}
                    ...
                    <div className="flex items-center justify-between flex-wrap">
                        ...
                        <div className="flex items-center flex-wrap gap-x-3 md:gap-x-0">
                            ...
                            <h2 className="text-lg font-semibold secpars" style={{display: 'none'}}>Facebook</h2>
                            <div className="ml-4 my-3 my-md-0 mll">
                                <h2 className="text-lg font-semibold secpar">Facebook</h2>
                    ...
                    <div className="flex items-center justify-between flex-wrap">
                        ...
                        <div className="flex items-center flex-wrap gap-x-3 md:gap-x-0">
                            ...
                            <h2 className="text-lg font-semibold secpars" style={{display: 'none'}}>Twitter</h2>
                            <div className="ml-4 my-3 my-md-0 mll">
                                <h2 className="text-lg font-semibold secpar">Twitter</h2>
